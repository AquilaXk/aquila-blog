...
이 문서는 Platform과 Web 사이의 공개 소유권 및 교차 저장소 이슈 관계의 최종 current map이다. [Platform #1466](https://github.com/AquilaXk/aquila-blog/issues/1466)은 이 최종 정본 문서 반영을 소유한다. Platform의 canonical contract·deployment consumer와 Web의 imported contract·frontend image producer 역할은 완료된 이력 및 현재 active row로 분리되어 있다.
...
- [Web repository](https://github.com/AquilaXk/aquila-blog-web)는 Next.js source, Web tests, imported Platform contract lock, frontend image build와 publication을 소유한다.
...
## Finalized Contract Handoff (2026-08-23)
...
- foreign write, dual write, fallback은 모두 0이다. 현재 public-contract receiver는 source repository, 40자리 source commit SHA, artifact SHA-256을 검증한 canonical handoff만 수용한다.
...
| [Platform #1498](https://github.com/AquilaXk/aquila-blog/issues/1498) | 없음 | Platform은 retired unpublished summary capability의 active environment, deployment, processor, data-map residue removal and narrow reintroduction validation을 소유한다. Web canonical-summary runtime에는 해당 capability가 없어 cleanup counterpart를 두지 않는다. |
| [Platform #1776](https://github.com/AquilaXk/aquila-blog/issues/1776) | [Web #136](https://github.com/AquilaXk/aquila-blog-web/issues/136), [Web #141](https://github.com/AquilaXk/aquila-blog-web/issues/141) | Platform은 administrator backend와 canonical public API contract production을 소유한다. Web #136은 generated-only contract consumption과 live harness·environment cleanup을, Web #141은 obsolete public-member source·configuration·storage·administrator-tool cleanup을 소유한다. 어느 저장소도 상대 저장소 source를 직접 수정하지 않는다. |
...
- [Platform #1683](https://github.com/AquilaXk/aquila-blog/issues/1683)와 [Web #70](https://github.com/AquilaXk/aquila-blog-web/issues/70)의 퇴역 legal handoff는 Platform #1805와 Web #169에서 정리됐다.
