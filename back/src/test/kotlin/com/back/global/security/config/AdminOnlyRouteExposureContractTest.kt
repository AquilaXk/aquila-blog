...
class AdminOnlyRouteExposureContractTest : BaseControllerIntegrationTest() {
    ...
    fun `retires public member and interaction route mappings while retaining blog and admin routes`() {
        ...
        listOf(
            ...
            HttpMethod.POST to "/member/api/v1/adm/privacy/requests",
            HttpMethod.POST to "/member/api/v1/adm/privacy/requests/1/exports",
            HttpMethod.POST to "/member/api/v1/adm/privacy/requests/1/deletions",
