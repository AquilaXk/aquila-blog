...
require_pattern 'FRONT_LIVE_VERIFY_PATHS_PATTERN=.*front/' "Web legal policy source changes must run live frontend verification"
require_pattern 'FRONT_BUILD_SHA_PATHS_PATTERN=.*legal/' "Web legal policy source changes must force live frontend sha equality"
