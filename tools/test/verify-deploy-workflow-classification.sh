...
require_pattern 'attestation-source-sha-mismatch' "workflow_run source-sha mismatch must record the fail-closed reason"
require_pattern 'result: blocked' "workflow_run source-sha mismatch must be reported as blocked"
require_pattern 'exit 1' "workflow_run source-sha mismatch must fail the Deploy workflow"
