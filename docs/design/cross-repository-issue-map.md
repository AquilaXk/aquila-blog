...
| [Platform #1498](https://github.com/AquilaXk/aquila-blog/issues/1498) | 없음 | Platform은 미구현 AI/Gemini의 active environment, deployment, processor, legal data-map residue 제거와 재도입 방지 검증을 소유한다. Web canonical-summary runtime에는 active AI/Gemini capability가 없어 cleanup counterpart를 두지 않으며, Web policy publication은 [Platform #1600](https://github.com/AquilaXk/aquila-blog/issues/1600)과 [Web #40](https://github.com/AquilaXk/aquila-blog-web/issues/40)이 별도로 소유한다. |
