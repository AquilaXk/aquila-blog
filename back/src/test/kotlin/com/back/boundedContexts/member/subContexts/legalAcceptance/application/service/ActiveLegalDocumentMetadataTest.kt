...
class ActiveLegalDocumentMetadataTest {
    ...
    fun currentMetadataMatchesPublicPolicySources() {
        ...
        val terms = readPolicyMetadata("../front/legal/policies/terms.ko-KR.v1.0.2.yaml")
        val privacy = readPolicyMetadata("../front/legal/policies/privacy.ko-KR.v1.0.3.yaml")
